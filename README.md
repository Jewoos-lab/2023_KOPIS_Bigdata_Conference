...
* Man whitey U test를 통한 가설검증
1) 경제성
   * 귀무가설(H0): 회복 극장의 지역은 비회복 극장의 지역과 지역 경제성 차이가 없을 것이다.
   * 대립가설(H1): 회복 극장의 지역은 비회복 극장의 지역과 지역 경제성 차이가 있을 것이다.
   * p_value(0.049) < a(0.05)으로 인한 대립가설 채택 -> 회복극장과 비회복극장은 경제성에서 유의한 차이를 보인다.
2) 접근성
   * 귀무가설(H0): 회복 극장의 지역은 비회복 극장의 지역과 접근성 차이가 없을 것이다.
   * 대립가설(H1): 회복 극장의 지역은 비회복 극장의 지역과 접근성 차이가 있을 것이다.
   * p_value(0.04) < a(0.05)으로 인한 대립가설 채택 -> 회복극장과 비회복극장은 접근성에서 유의한 차이를 보인다.
3) 공연검색량
   * 귀무가설(H0): 회복 극장의 지역은 비회복 극장의 지역과 공연검색량의 차이가 없을 것이다. 
   * 대립가설(H1): 회복 극장의 지역은 비회복 극장의 지역과 공검색량의 차이가 있을 것이다.
   * p_value(0.5) > a(0.05)으로 인한 대립가설 기각 -> 공연검색량은 회복극장과 비회복극장은 공연검색량에서 차이가 없다.
